...
{
  LogComponentEnable ("Ipv6ListRouting", LOG_LEVEL_FUNCTION);
  LogComponentEnable ("Ipv6L3Protocol", LOG_LEVEL_FUNCTION);
  LogComponentEnable ("Icmpv6L4Protocol", LOG_LEVEL_FUNCTION);
  LogComponentEnable ("Ipv6StaticRouting", LOG_LEVEL_FUNCTION);
  LogComponentEnable ("Ipv6Interface", LOG_LEVEL_FUNCTION);
  LogComponentEnable ("Ping6Application", LOG_LEVEL_FUNCTION);
