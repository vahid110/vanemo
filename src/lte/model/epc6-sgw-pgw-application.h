...
#ifndef EPC6_SGW_PGW_APPLICATION_H
#define EPC6_SGW_PGW_APPLICATION_H
 ...
 */
class Epc6SgwPgwApplication : public Application
{
  friend class MemberEpcS11SapSgw<Epc6SgwPgwApplication>;
...
public:
   ...
   * the Gi interface of the PGW/SGW over the internet over GTP-U/UDP/IP
   * on the S1-U interface
   * \param s1uSocket socket used to send GTP-U packets to the eNBs
   */
  Epc6SgwPgwApplication (const Ptr<VirtualNetDevice> tunDevice, const Ptr<Socket> s1uSocket);

  /** 
   * Destructor
   */
  virtual ~Epc6SgwPgwApplication (void);
...
#endif /* EPC6_SGW_PGW_APPLICATION_H */
